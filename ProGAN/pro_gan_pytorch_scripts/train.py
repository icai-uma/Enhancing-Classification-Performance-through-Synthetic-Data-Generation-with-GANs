...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--depth", action="store", type=int, default=9, required=False,
    ...
    parser.add_argument("--num_workers", action="store", type=int, required=False, default=1,
    ...
    parser.add_argument("--checkpoint_factor", action="store", type=int, required=False, default=42,
