...
import argparse
from utils import get_loader, gradient_penalty, get_custom_loader
...
def main():
    ...
    for num_epochs in progressive_epochs[step:]:
        ...
        loader, dataset = get_custom_loader(image_size, args.workers, batch_size, '/home/joseruiz/Desktop/Doctorado/dataset', args.data_ratio)
    ...
    gen.save('progan_b.pt')
    print(f'ALPHA: {alpha}, STEP: {step}')
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--in_channels', type=int, default=128)
    ...
    argparser.add_argument('--g', type=int, default=10)
